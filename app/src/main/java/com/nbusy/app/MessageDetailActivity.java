...
/**
 * An activity representing a single Message detail screen. This activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items in a {@link MessageListActivity}.
 * <p/>
 * This activity is mostly just a 'shell' activity containing nothing more than a {@link MessageDetailFragment}.
 */
